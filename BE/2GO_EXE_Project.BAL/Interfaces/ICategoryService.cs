...
{
    Task<CategoryListResponse> GetCategoriesAsync(string? search, int skip, int take, bool includeSubCategories = false, bool? subIsActive = null, bool? isActive = null, CancellationToken cancellationToken = default);
    Task<CategoryResponse?> GetByIdAsync(int id, bool includeSubCategories = false, bool? subIsActive = null, bool? isActive = null, CancellationToken cancellationToken = default);
