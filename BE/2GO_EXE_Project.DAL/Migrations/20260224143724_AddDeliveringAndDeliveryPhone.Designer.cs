...
namespace _2GO_EXE_Project.DAL.Migrations
{
    ...
    [Migration("20260224143724_AddDeliveringAndDeliveryPhone")]
    partial class AddDeliveringAndDeliveryPhone
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.AiAnalysisLog", b =>
                {
                    b.Property<long>("LogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("LogId")
                        .HasName("PK_AIAnalysisLog");

                    b.ToTable("AIAnalysisLog");
                });

            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.AiImageVisionCache", b =>
                {
                    b.Property<long>("CacheId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("CacheId"));
                    ...
                    b.Property<string>("DamageLabels")
                        .HasMaxLength(1000)
                    ...
                    b.HasKey("CacheId")
                        .HasName("PK_AiImageVisionCache");

                    b.HasIndex("ImageUrl")
                        .HasDatabaseName("IX_AiImageVisionCache_ImageUrl");

                    b.ToTable("AiImageVisionCaches");
                });
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.ApiLog", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("ApiId"));
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.Bank", b =>
                {
                    ...
                    b.HasKey("BankId")
                        .HasName("PK__Banks__AA08CB13F44A7FD0");
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.EscrowContract", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("EscrowId"));
                    ...
                    b.Property<DateTime?>("DepositDeadlineAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("DepositForfeitedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("DepositReminderSentAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.EscrowTransaction", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("TxId"));
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.ManualReviewQueue", b =>
                {
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.Report", b =>
                {
                    ...
                    b.Property<long?>("WaitingForUserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.SavedListing", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("SavedId"));
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.SearchHistory", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("SearchId"));
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.ShippingRequest", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("ShipId"));
            ...
            modelBuilder.Entity("_2GO_EXE_Project.DAL.Entities.UserPoint", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("PointId"));
